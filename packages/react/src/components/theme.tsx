...
export const themeMap = createThemeMap({
  base: {
    header: "capitalize text-2xl font-medium text-gray-900",
  ...
  dark: {
    header: "capitalize text-2xl font-medium text-white",
  ...
  w3fs: {
    header:
      "capitalize text-2xl font-medium bg-clip-text text-transparent Pastel bg-gradient-to-tr from-pink-500 to-orange-300",
    text: "mt-1 text-sm text-slate-200 truncate mb-4",
    button:
  ...
  midnight: {
    header: "capitalize text-2xl font-medium text-sky-100",
  ...
  elegant: {
    header: "capitalize text-2xl font-medium text-zinc-100",
