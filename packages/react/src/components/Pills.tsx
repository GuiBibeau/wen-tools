...
export const NotConnectedPill = () => {
	return (
		<span
			className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-stone-200 text-stone-900"
		>
			Not Connected
		</span>
	);
...
export const LoadingPill = () => {
	return (
		<span
			className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-sky-500 text-sky-100"
		>
